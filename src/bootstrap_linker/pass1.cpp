/**
 * \file src/bootstrap_linker/pass1.cpp
 *
 * \brief Driver for the first linker pass.
 *
...
void bootstrap_linker::pass1(istream& in, ostream& log)
{
    bool in_pass = true;
    ...
    while (in.good() && in_pass)
    {
        ...
        // decode the line
        decodeLine1(*f, string(f+1, line.end()), in_pass, log);
    }
}
